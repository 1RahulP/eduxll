...
const Button = ({
  ...
  return (
    <>
      <button
        className={`border border-red-500 py-2 px-4 h-fit rounded-md leading-none flex items-center gap-2 ${className}`}
        onClick={onClick}
      >
        {notesImage && (
        ...
        {dropdownImage && (
          <Image src="/triangle.png" alt="globe" width={16} height={16} />
        )}
      </button>
    </>
  );
